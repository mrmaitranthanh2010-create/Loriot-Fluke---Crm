      ...
      <div className="modal email-compose-modal" role="dialog" aria-modal="true" aria-label="Soạn email cho Lead">
        ...
        <form onSubmit={sendEmails}><div className="modal-body email-compose-grid">
          ...
          <section className="email-composer">
            ...
            <aside className="email-signature-preview"><span>CHỮ KÝ TỰ ĐỘNG</span><div className="email-signature-greeting">Thanks and best regards,</div><div className="email-signature-card"><div className="email-signature-logo" role="img" aria-label="Loriot Industrial" style={{ backgroundImage: `url(${LORIOT_LOGO_DATA_URL})` }}/><div className="email-signature-details"><strong>Mai Trần Thành (Mr.)</strong><small className="email-signature-company">LORIOT INDUSTRIAL CO., LTD</small><small><b>T</b> (+84) 964 72 72 33</small><small><b>E</b> hn.sales3@loriot.com.vn</small></div></div></aside>
